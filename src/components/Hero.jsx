    ...
    <div className="hero">
      ...
      <>
        <div className="hero__descrption">
          ...
          <div className="hero__descrption__para fw-medium ff-base fs-4 fw-medium ">
          ...
          <div className="hero__descrption__stats ff-base border-2 border-radius-10 box-shadow-1 bg-primary-300">
            <div className="stat">
